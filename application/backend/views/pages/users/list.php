...
<script type="text/javascript" >
    ...
    $(document).ready(function() {
        ...
        jQuery("#list").jqGrid({
            ...
            autoencode: true,
            loadonce: false,
            colNames: ['ID', 'Login', 'Last Login'],
            colModel: [
                {name: 'id', index: 'id',  editable: false, editoptions: {readonly: true, size: 10}},
                {name: 'login', index: 'login',  height: 50, resizable: true, align: "left", editable: true, edittype: "text"},
                {name: 'last_login', index: 'last_login',  resizable: true, align: "left", sorttype: "text", editable: true, edittype: "text"},
            ],
            rowNum: 15,
            multiselect: true,
            rowList: [15, 30, 45],
